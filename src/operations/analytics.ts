 ...
 */
export async function getKongStatus(api: KongOssApi) {
    try {
 ...
 */
export async function getKongMetrics(api: KongOssApi) {
    try {
 ...
 */
export async function getKongHealth(api: KongOssApi) {
    try {
 ...
 */
export async function getPluginStats(api: KongOssApi) {
    try {
        ...
        return {
            ...
            plugins: plugins.data?.map((plugin: any) => ({
                id: plugin.id,
                name: plugin.name,
